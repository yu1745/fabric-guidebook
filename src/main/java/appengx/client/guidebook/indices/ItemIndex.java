package appengx.client.guidebook.indices;
...
import appengx.client.guidebook.compiler.IdUtils;
 ...
 * <p/>
 * This index is installed by default on all {@linkplain appengx.client.guidebook.Guide guides}.
 */

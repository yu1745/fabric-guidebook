package appengx.client.guidebook.render;
...
import appengx.api.stacks.AEFluidKey;
import appengx.client.gui.Icon;
import appengx.client.gui.style.BackgroundGenerator;
import appengx.client.gui.style.FluidBlitter;
import appengx.client.guidebook.color.ColorValue;
import appengx.client.guidebook.color.ConstantColor;
import appengx.client.guidebook.color.LightDarkMode;

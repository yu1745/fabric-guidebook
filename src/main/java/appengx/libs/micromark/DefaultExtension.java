...
import appengx.libs.micromark.commonmark.Attention;
import appengx.libs.micromark.commonmark.AutoLink;
import appengx.libs.micromark.commonmark.BlockQuote;
import appengx.libs.micromark.commonmark.CharacterEscape;
import appengx.libs.micromark.commonmark.CharacterReference;
import appengx.libs.micromark.commonmark.CodeFenced;
import appengx.libs.micromark.commonmark.CodeIndented;
import appengx.libs.micromark.commonmark.CodeText;
import appengx.libs.micromark.commonmark.Definition;
import appengx.libs.micromark.commonmark.HardBreakEscape;
import appengx.libs.micromark.commonmark.HeadingAtx;
import appengx.libs.micromark.commonmark.HtmlFlow;
import appengx.libs.micromark.commonmark.HtmlText;
import appengx.libs.micromark.commonmark.LabelEnd;
import appengx.libs.micromark.commonmark.LabelStartImage;
import appengx.libs.micromark.commonmark.LabelStartLink;
import appengx.libs.micromark.commonmark.ListConstruct;
import appengx.libs.micromark.commonmark.SetextUnderline;
import appengx.libs.micromark.commonmark.ThematicBreak;
...
public final class DefaultExtension {
    ...
    public static Extension create() {
        ...
        extension.text.put(Codes.carriageReturn, List.of(appengx.libs.micromark.commonmark.LineEnding.lineEnding));
        extension.text.put(Codes.lineFeed, List.of(appengx.libs.micromark.commonmark.LineEnding.lineEnding));
        extension.text.put(Codes.carriageReturnLineFeed,
                List.of(appengx.libs.micromark.commonmark.LineEnding.lineEnding));
